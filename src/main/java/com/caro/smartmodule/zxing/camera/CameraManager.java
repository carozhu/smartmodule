...
//	private static final int MAX_FRAME_WIDTH = 1200; // = 5/8 * 1920
	...
	private static final int MAX_FRAME_WIDTH = 1900; // = 5/8 * 1920
	...
	public synchronized Rect getFramingRectInPreview() {
		if (framingRectInPreview == null) {
			...
			Log.d(TAG, "caro Calculated framingRectInPreview rect: " + framingRectInPreview);
			Log.d(TAG, "cameraResolution: " + cameraResolution);//etc:1920,1080
			Log.d(TAG, "screenResolution: " + screenResolution);//etc:1080,1920
		}
