...
import com.caro.smartmodule.zxing.CaptureActivity;
import com.caro.smartmodule.zxing.camera.CameraManager;
import com.caro.smartmodule.zxing.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
	...
	public void handleMessage(Message message) {
	    ...
	    if (msgId == R.id.restart_preview){
		  Log.d(TAG, "Got restart preview message");
		  restartPreviewAndDecode();
	    }

	    if (msgId == R.id.decode_succeeded){
	    ...
	    if (msgId == R.id.return_scan_result){
		  Log.d(TAG, "Got return scan result message");
		  activity.setResult(Activity.RESULT_OK, (Intent) message.obj);
		  activity.finish();
	    }
	    if (msgId == R.id.launch_product_query){
