...
/**
 * Created by caro on 9/29/15.
 * USAGE:
 * addOnScrollListener setOnScrollListener is deprecated.
 * addOnScrollListener(OnScrollListener) means you can add more than one listener to a RecyclerView.
 * removeOnScrollListener(OnScrollListener) means you can remove one of the listeners that attached to a specific RecyclerView.
 * If the arg was set null, it equals to clearOnScrollListeners() method.
 ...
 * }
 * });
 * FORM:http://stackoverflow.com/questions/29971917/android-setonscrolllistner-on-recyclerview-deprecated
 */
