 ...
 * per:http://www.jb51.net/article/40679.htm
 */
...
public class SmartRadioGroup extends LinearLayout {
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        public void onCheckedChanged(SmartRadioGroup group, int checkedId);
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == SmartRadioGroup.this && child instanceof RadioButton) {
                int id = child.getId();
            ...
            } else if (parent == SmartRadioGroup.this
