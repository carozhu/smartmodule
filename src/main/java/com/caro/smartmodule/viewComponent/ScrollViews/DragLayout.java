 ...
 *         http://gundumw100.iteye.com/blog/2249642
 *         caro :根据作者基础上进行改进。并感谢之
 *         <p>
 *         <com.caro.Custom.drager.DragLayout
 ...
 *         </com.caro.Custom.drager.DragLayout>
 *         <p>
 *         public void configDragerPage() {
 *         PDPF = ProdDetailPicFragment.CreateInstance(goods);
 *         webFragment = CommWebFragment.CreateInstance(null, null);
 *         <p>
 *         getSupportFragmentManager().beginTransaction()
 *         .add(R.id.first, PDPF).add(R.id.second, webFragment)
 *         .commit();
 *         <p>
 *         DragLayout.ShowNextPageNotifier nextIntf = new DragLayout.ShowNextPageNotifier() {
 * @Override public void onDragNext() {
 * if (goods != null) {
 * webFragment.loadURL(Consts.o2oShopGoodsDescHtml_URL + goods.getId());
 * }
 * <p>
 * }
 * };
