package com.caro.smartmodule.viewComponent.progress;
...
/**
 * 特别感谢：com.liuhb.taobaoprogressbar.com.liuhb.taobaoprogressbar.view;
 * Created by huibin on 15/5/20.
 */
public class RushActivitiesProgressBar extends View {
    ...
    public RushActivitiesProgressBar(Context context) {
        this(context, null);
    }

    public RushActivitiesProgressBar(Context context, AttributeSet attrs) {
    ...
    public RushActivitiesProgressBar(Context context, AttributeSet attrs,
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.RushActivitiesProgressBar);
        try {
            mMax = a.getInt(R.styleable.RushActivitiesProgressBar_max, DEFAULT_MAX);
            mProgress = a.getInt(R.styleable.RushActivitiesProgressBar_progress,
                    DEFAULT_PROGRESS);
            mRadius = (int) a.getDimension(
                    R.styleable.RushActivitiesProgressBar_progressRadius, DEFAULT_RADIUS);
            mProgressColor = a.getColor(
                    R.styleable.RushActivitiesProgressBar_progressColor,
                    DEFAULT_PROGRESS_COLOR);
            mProgressDescColor = a.getColor(
                    R.styleable.RushActivitiesProgressBar_progressDescColor,
                    DEFAULT_PROGRESS_DESC_COLOR);
            mBorderWidth = (int) a.getDimension(
                    R.styleable.RushActivitiesProgressBar_progressborderWidth,
                    DEFAULT_BORDER_WIDTH);
            mProgressDesc = a
                    .getString(R.styleable.RushActivitiesProgressBar_progressDesc);
            mIsShowDesc = a.getBoolean(R.styleable.RushActivitiesProgressBar_isShowDesc,DEFAULT_ISSHOWDESC) ;
