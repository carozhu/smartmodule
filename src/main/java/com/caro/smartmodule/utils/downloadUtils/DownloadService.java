package com.caro.smartmodule.utils.downloadUtils;

/**
 * Created by caro on 11/18/15.
 */
...
public class DownloadService {
    ...
    private static final String CACHE_FILENAME_PREFIX = "sharecache";
